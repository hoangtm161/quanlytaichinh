                    ...
                    <div class="card-body">
                        <form style="margin-top: 25px;" method="POST" action="{{route('wallet.update',['id' => $wallet->id])}}" aria-label="{{ __('Register') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input  id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ $wallet->name }}" name="name" autofocus required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="" type="number" class="form-control{{ $errors->has('balance') ? ' is-invalid' : '' }}" value="{{ $wallet->balance }}" disabled>
